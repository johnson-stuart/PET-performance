...
{
  public:
    B3DetectorConstruction(B3PrimaryGeneratorAction*);
	...
	G4double GetCylinderRadius() const { return fCylRadius; }
  ...
  private:
	...
	G4LogicalVolume* fLogicRing;
	G4LogicalVolume* fLogicDet;
	G4LogicalVolume* fLogicCyl;
	
	G4double fCylRadius;
	
	G4MultiFunctionalDetector* fCryst;
	G4MultiFunctionalDetector* fTank;

	
	B3PrimaryGeneratorAction* fPrimaryGenerator;
