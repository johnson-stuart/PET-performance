...
class B3PrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
	...
	void SetAxialPosition(G4double axial_offset);
	void SetZPosition(G4double z_offset);
	
	const G4ParticleGun* GetParticleGun() const { return fParticleGun1; }
	const G4ThreeVector GetPosition() const { return fAx_position; }
  ...
  G4ThreeVector          fAx_position;
  G4double                  fZ_position;
